...
public class MainPanel extends JPanel {
    ...
    public static int convertToInt(int x) {
    	/*
    	 * this section of the code seemed to be just calling several methods and creating strings 
    	 * for no reason. As a result, I removed it and replaced it with a simple check
    	 * to see if the number was negative. If so, create an exception. Else, return an int.
    	 */
	...
	*/
	...
	while (_running) {
	    ...
	    /* 
	     * this for loop seemed to be just running for the sake of running, as 
	     * the associated variables never ran
	     */
